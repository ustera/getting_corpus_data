...
check_question(answer =  'soup.find("div", attrs={"class": "news-title__name"}).get_text()', right = "correct", wrong = "not correct")
```

Введите функцию для поиска текста статьи

```{r, echo=FALSE, results='asis'}
check_question(answer =  'soup.find("div", attrs={"class": "news-content"}).get_text()', right = "correct", wrong = "not correct")
```
